...
//        mTabStrip.setCustomTabColorizer(tabColorizer);
    ...
    public void setSelectedIndicatorColors(int... colors) {
        mTabStrip.setSelectedIndicatorColors(R.color.pink);
    }
    ...
    private void populateTabStrip() {
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            if(i==0)
            {
                tabTitleView.setText("EXPLORE");
            }
            if(i==1)
            {
                tabTitleView.setText("HAPPY ");
            }

            if(i==2)
            {
               tabTitleView.setText("NEARBY");
            }

            if(i==3)
            {
                tabTitleView.setText("OFFERS");
            }
...
//            tabTitleView = (TextView) selectedTitle.findViewById(mTabViewTextViewId);
